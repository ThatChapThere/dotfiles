...
" Custom Changes
syntax match userDefinedVariable '\<\zs\h\w*\ze\>'
syntax match userDefinedClass '\<\zs\h\w*\ze\>[ \t\n]*{'
syntax match userDefinedType '\<\zs\h\w*\ze\>[a-zA-Z<>*&_]*[ \n\t]\+[*&]*[a-zA-Z_]'
syntax match regularNamespace '\<\zs\h\w*\ze\>::\h\w*'
syntax match classNamespace '\<\zs\h\w*\ze\>::\h\w*('
syntax match PreProc '#define'
syntax match PreProc '#pragma once'
...
syntax keyword Test lmao lol wtf

" Default highlighting
hi def link Test Typedef
